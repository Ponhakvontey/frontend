...
export const mockNavLinks: NavLink[] = [
  { id: 1, label: 'Home', slug: '/', active: true },
  { id: 2, label: 'Collections', slug: '/collections', active: false },
...
export const mockHeroContent: HeroContent = {
  ...
  description:
    'Discover editorial pieces that blend craft, comfort, and timeless design language.',
...
export const mockJournalContent: JournalContent = {
  ...
  description:
    'Stories, spaces, and product narratives from our design editors and collaborators.',
